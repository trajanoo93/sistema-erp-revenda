console.log("pedidos.js: Arquivo carregado com sucesso (versão 174.17).");
$(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (typeof $.fn.modal === 'function') {
                            ...
                            console.error("Método modal não disponível para handleUpdate.");
                        }
                    },
                    error: function(xhr, status, error) {
    ...
    // Inicializar o evento do botão Novo Pedido com atraso
    setTimeout(function() {
        bindNovoPedidoEvent();
        bindFilterEvents();
